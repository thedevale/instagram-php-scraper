...
class Endpoints
{
    ...
    const LIKES_BY_SHORTCODE = 'https://www.instagram.com/graphql/query/?query_hash=d5d763b1e2acf209d62d22d184488e57';
    ...
    public static function getLastLikesByCode($code, $count, $lastLikeID)
    {
        ...
        if($lastLikeID && strlen($lastLikeID) > 5){
            $variables['after'] = $lastLikeID;
        }

        $variables = urlencode(json_encode($variables));

        return static::LIKES_BY_SHORTCODE."&variables=".$variables;
    }
